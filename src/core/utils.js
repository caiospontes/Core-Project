...
export { sortTools, getCompositeKey, buildKeyCandidates, resolveKeyFromMap, formatDateToBR, getTodayBR, formatDateToISOInput, normalizeScannerText, buildNotebookBarcodeValue, parseNotebookBarcodeValue };
