...
function SafePreview({ html }) {
  ...
  const parsedPreview = useMemo(() => {
    ...
    return { isFullHtml: hasFullHtml, fullHtml: html || '' };
  }, [html]);
  ...
  useEffect(() => {
    if (!containerRef.current || parsedPreview.isFullHtml) return;
