...
function SafePreview({ html }) {
  ...
  const parsedPreview = useMemo(() => {
    ...
    if (!hasFullHtml || typeof window === 'undefined') {
      return { isFullHtml: false, headStyles: '', bodyContent: html || '' };
    }
    ...
    shadowRoot.innerHTML = `
      <style>
        ...
        * { box-sizing: border-box; }
        ...
        ${parsedPreview.isFullHtml ? '' : 'table { width: 100% !important; border-collapse: collapse; table-layout: fixed; } td, th { word-wrap: break-word; overflow-wrap: break-word; }'}
        @media print { :host { display: none; } }
      </style>
      ${parsedPreview.headStyles}
      ${parsedPreview.bodyContent}
    `;
  }, [parsedPreview]);
