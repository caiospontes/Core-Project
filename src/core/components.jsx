...
import { sortTools, getCompositeKey, resolveKeyFromMap, formatDateToBR, getTodayBR, buildNotebookBarcodeValue, parseNotebookBarcodeValue } from './utils';
                 ...
                 <div className="space-y-6">
                     <div className="bg-white p-6 rounded-lg shadow-sm border border-slate-200">
                         ...
                         <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                            ...
                            <input value={newLog.date} onChange={e => setNewLog({...newLog, date: e.target.value})} placeholder="DD/MM/AAAA" className="border border-slate-300 p-2 rounded-md text-sm outline-none focus:border-blue-500 text-slate-600"/>
  ...
  const renderTagInput = (tag) => (
    <div key={tag.id} className="bg-white p-3 rounded-md border border-slate-200 shadow-sm focus-within:border-blue-400 focus-within:ring-1 focus-within:ring-blue-400 transition-all">
      ...
      {tag.type === 'checkbox' ? (
        ...
        <>
          <input
            type={tag.type === 'date' ? 'text' : tag.type}
