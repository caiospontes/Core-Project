          ...
          <div className="bg-gradient-to-r from-blue-700 via-blue-600 to-cyan-600 px-6 md:px-8 py-7 text-white">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
              <div>
                ...
                <h1 className="text-3xl font-bold tracking-tight mt-2">Bem-vindo ao CORE ERP</h1>
...
function DynamicGenerator({ template, tagsConfig, delimiters, moduleId, cepMappings, correiosPresets = [], isAdmin = false }) {
  ...
  const handlePrint = () => {
      ...
      printDocument.open();
      printDocument.write(`<html><head><title>Documento Operacional</title><style>@page { size: A4 portrait; margin: 6mm; } html, body { margin: 0; padding: 0; font-family: Arial, sans-serif; background: white; } body { width: auto; height: auto; } img { max-width: 100%; height: auto; } * { -webkit-print-color-adjust: exact; print-color-adjust: exact; box-sizing: border-box; } table { border-collapse: collapse; width: 100%; } table, tr, td, th { page-break-inside: avoid; } .print-page-break { break-after: page; page-break-after: always; }</style></head><body>${printContent}</body></html>`);
      printDocument.close();
